  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="flex">
        ...
        <aside
          className={`
            fixed top-0 left-0 z-50 h-full w-72 max-w-[85vw] border-r border-slate-200 bg-white shadow-xl
            transform transition-transform duration-200 ease-out lg:relative lg:z-auto lg:translate-x-0 lg:shadow-none
        ...
        >
            ...
            <div className="flex items-center justify-between p-4 lg:p-6">
              <div className="min-w-0">
                <Link
                  href="/"
                  onClick={closeSidebar}
                  className="text-xl font-bold text-blue-600 hover:text-blue-700 block"
                >
                  LaCleoOmnia
                </Link>
          ...
          {/* Navigation */}
          <nav className="px-6 space-y-1 flex-1">
            {navItems.map((item) => {
